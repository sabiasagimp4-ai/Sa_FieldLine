...
/// <summary>StretchInit.hlsl のパス。定数バッファは float4 x 6 固定。</summary>
internal sealed class StretchInitPass : D2D1CustomShaderEffectBase
{
    public StretchInitPass(IGraphicsDevicesAndContext devices) : base(Create<Impl>(devices))
    {
    ...
    internal sealed class Impl : D2D1CustomShaderEffectImplBase<Impl>
    {
        ...
        public Impl() : base(ShaderResourceLoader.Get("StretchInit")) { }
